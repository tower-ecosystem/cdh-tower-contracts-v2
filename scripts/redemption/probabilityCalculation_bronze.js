...
console.log(`Rare: ${rareCardProbabilityInFirstCards} Epic: ${epicCardProbabilityInFirstCards} Common: ${commonCardProbabilityInFirstCards} Total probability: ${rareCardProbabilityInFirstCards+epicCardProbabilityInFirstCards+commonCardProbabilityInFirstCards}`)
...
console.log(`Rare: ${rareCardProbabilityInSecondCards} Epic: ${epicCardProbabilityInSecondCards} Common: ${commonCardProbabilityInSecondCards} Total probability: ${rareCardProbabilityInSecondCards+epicCardProbabilityInSecondCards+commonCardProbabilityInSecondCards}`)
...
console.log(`Rare: ${rareCardProbabilityInThirdCards} Epic: ${epicCardProbabilityInThirdCards} Common: ${commonCardProbabilityInThirdCards} Total probability: ${rareCardProbabilityInThirdCards+epicCardProbabilityInThirdCards+commonCardProbabilityInThirdCards}`)
