...
console.log(`Rare: ${rareCardProbabilityInFirstCards} Epic: ${epicCardProbabilityInFirstCards} Legendary: ${legendaryCardProbabilityInFirstCards} Total probability: ${rareCardProbabilityInFirstCards+epicCardProbabilityInFirstCards+legendaryCardProbabilityInFirstCards}`)
...
console.log(`Rare: ${rareCardProbabilityInSecondCards} Epic: ${epicCardProbabilityInSecondCards} Legendary: ${legendaryCardProbabilityInSecondCards} Total probability: ${rareCardProbabilityInSecondCards+epicCardProbabilityInSecondCards+legendaryCardProbabilityInSecondCards}`)
...
console.log(`Rare: ${rareCardProbabilityInThirdCards} Epic: ${epicCardProbabilityInThirdCards} Legendary: ${legendaryCardProbabilityInThirdCards} Total probability: ${rareCardProbabilityInThirdCards+epicCardProbabilityInThirdCards+legendaryCardProbabilityInThirdCards}`)
...
console.log(`Rare: ${rareCardProbabilityInFourthCards} Epic: ${epicCardProbabilityInFourthCards} Legendary: ${legendaryCardProbabilityInFourthCards} Total probability: ${rareCardProbabilityInFourthCards+epicCardProbabilityInFourthCards+legendaryCardProbabilityInFourthCards}`)
...
console.log(`Rare: ${rareCardProbabilityInFifthCards} Epic: ${epicCardProbabilityInFifthCards} Legendary: ${legendaryCardProbabilityInFifthCards} Total probability: ${rareCardProbabilityInFifthCards+epicCardProbabilityInFifthCards+legendaryCardProbabilityInFifthCards}`)
