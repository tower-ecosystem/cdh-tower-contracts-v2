...
const REDEMPTION_SIGNER_PRIVATE_KEY = '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80';
...
const signOrderPayload = async (payload) => {
  ...
  console.log(`Seed Nonce for sender - ${sender} : "${contractAddress}" in Contract: ${seedNonce}`);
  const hash = web3.utils.soliditySha3(sender, contractAddress, quantity.toString(), ticketType.toString(), seedNonce.toString());
